...
<div class="shadow-box">
	<div class="filter">
		<ul class="">
			<li><a class="active" href="${base}/home/follows/1">我的关注</a></li>
			<li><a href="${base}/home/fans/1">我的粉丝</a></li>
		</ul>
	</div>
	<!-- tab panes -->
				...
				<div class="summary">
					...
					<div class="foot-block clearfix">
						...
						<div class="pull-right hidden-xs">
							<a class="btn btn-success btn-xs" href="javascript:void(0);" data-id="${row.user.id}" rel="unfollow" style="color: #fff;">取消关注</a>
						</div>
					</div>
				</div>
			</div>
...
$(function() {
	$('a[rel=unfollow]').click(function () {
		...
		layer.confirm('确定取消关注TA吗?', {
			...
			jQuery.getJSON('${base}/api/unfollow.json/' + id ,  function (ret) {
