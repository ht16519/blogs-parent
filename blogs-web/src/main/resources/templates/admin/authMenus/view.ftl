    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form id="qForm" class="form-horizontal form-label-left" method="post" action="${base}/admin/menu/save">
                    <#if data?? && (data.id > 0)>
                    ...
                    <#-- TODO 上级菜单选择<div class="form-group">-->
                        ...
                        <#--<div class="col-lg-6">-->
                            <#--<input id="parentId" type="hidden" name="parentId" value="<#if parentId??>${parentId}<#else>${data.parenId}</#if>">-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" placeholder="请输入菜单名称" name="name" value="${data.name}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" placeholder="请输入顺序" name="sort" value="${data.sort}">
                        </div>
                    </div>
