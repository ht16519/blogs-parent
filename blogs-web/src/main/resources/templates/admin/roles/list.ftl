        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <@shiro.hasPermission name="sys:roles:edit">
                        <li><a href="${base}/admin/role/view/-1">添加角色</a>
                        </li>
                    </@shiro.hasPermission>
                </ul>
            ...
            <#--<input type="hidden" name="pn" value="${data.pageNo}"/>-->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <@shiro.hasPermission name="sys:roles:edit">
                                    <a href="${base}/admin/role/view/${row.id}" class="btn btn-xs btn-primary">
                                        <i class="fa fa-check-square-o"></i> 修改
                                    </a>
                                    <a href="${base}/admin/role/delete/${row.id}" onclick="return confirm('确定删除：${row.name}角色吗？')"
